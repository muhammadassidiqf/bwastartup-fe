                    ...
                    <div class="w-full lg:w-1/2 px-10 lg:px-0">
                        ...
                        <div class="mb-6">
                            <div class="mb-4">
                                ...
                                <input type="email"
                                    ...
                                    placeholder="Write your email address here" v-model="email" />
                            </div>
                        </div>
                        <div class="mb-6">
                            <div class="mb-4">
                                ...
                                <input type="password"
                                    class="auth-form focus:outline-none focus:bg-purple-hover focus:shadow-outline focus:border-purple-hover-stroke focus:text-gray-100"
                                    placeholder="Write your password here" v-model="password" />
                            </div>
                        </div>
                        <div class="mb-6">
                            <div class="mb-4">
                        ...
                        <div class="text-center">
                            <p class="text-white text-md">
                                Don't have account?
                                <NuxtLink to="/register" class="no-underline text-orange-button">Sign Up</NuxtLink>.
                            </p>
                        </div>
                    </div>
                </div>
